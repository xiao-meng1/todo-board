...
const init = () => {
    ...
    board = _model_js__WEBPACK_IMPORTED_MODULE_0__.getBoard();
    _view_js__WEBPACK_IMPORTED_MODULE_1__.initializeTemplate();

    for (let listKey in board) {
        list = board[listKey];
        _view_js__WEBPACK_IMPORTED_MODULE_1__.createList(list);
...
/* harmony import */ var _icons_add_black_24dp_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../icons/add_black_24dp.svg */ "./src/icons/add_black_24dp.svg");
/* harmony import */ var _icons_close_black_24dp_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../icons/close_black_24dp.svg */ "./src/icons/close_black_24dp.svg");
/* harmony import */ var _icons_radio_button_unchecked_black_24dp_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../icons/radio_button_unchecked_black_24dp.svg */ "./src/icons/radio_button_unchecked_black_24dp.svg");
...
const createList = (listObject) => {
    ...
    plusIcon.src = _icons_add_black_24dp_svg__WEBPACK_IMPORTED_MODULE_1__;
...
const createPopupTemplate = () => {
    ...
    icon.classList = "icon";
    icon.src = _icons_close_black_24dp_svg__WEBPACK_IMPORTED_MODULE_2__;
...
const dateContainerExists = (listKey, datetime) => {
    ...
    const date = (datetime === "") ? "NO DUE DATE" : 
        (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(datetime), 'E MMM d, y').toUpperCase();
...
const addDateContainer = (list, dateContainer) => {
    ...
    for (let i = 0; i < dateContainers.length; i++) {
        ...
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(
                (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(dateContainer.dataset.date, 'E MMM d, y', new Date()),
                (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(dateContainers[i].dataset.date, 'E MMM d, y', new Date())
            ) === 1) {
            uncompleteContainer.insertBefore(dateContainer, dateContainers[i]);
...
const createTask = (listKey, taskObject) => {
    ...
    const date = (taskObject.datetime === "") ? "NO DUE DATE" : 
        (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(taskObject.datetime), 'E MMM d, y').toUpperCase();
    const time = (taskObject.datetime === "") ? "" :
        (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(taskObject.datetime), 'h:mm aaaa');
    ...
    icon.classList = "icon";
    icon.src = _icons_radio_button_unchecked_black_24dp_svg__WEBPACK_IMPORTED_MODULE_3__;
    icon.addEventListener("click", () => {
        _controller_js__WEBPACK_IMPORTED_MODULE_0__.deleteTask(listKey, taskObject.key);
    });
...
const addTask = (listKey, taskContainer) => {
    ...
    for (let i = 0; i < taskContainers.length; i++) {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(
            (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(taskContainer.dataset.time, 'h:mm aaaa', new Date()),
            (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(taskContainers[i].dataset.time, 'h:mm aaaa', new Date())
        ) === 1) {
...
/***/ "./src/icons/add_black_24dp.svg":
/*!**************************************!*\
  !*** ./src/icons/add_black_24dp.svg ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "cf56b2a643aaf3123bac.svg";
...
module.exports = __webpack_require__.p + "b529109f9e749db4bb0b.svg";

/***/ }),

/***/ "./src/icons/radio_button_unchecked_black_24dp.svg":
/*!*********************************************************!*\
  !*** ./src/icons/radio_button_unchecked_black_24dp.svg ***!
  \*********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "ee3e4a558b55a9bc82e8.svg";
